...
**Current application version**: 2.2.0 (Web UI 2.2.1)

- **[64-bit](http://web-builds.airdcpp.net/stable/airdcpp_2.2.0_webui-2.2.1_64-bit_portable.tar.gz)**
- **[32-bit](http://web-builds.airdcpp.net/stable/airdcpp_2.2.0_webui-2.2.1_32-bit_portable.tar.gz)**
- **[ARM](http://web-builds.airdcpp.net/stable/airdcpp_2.2.0_webui-2.2.1_armhf_portable.tar.gz)**
