...
**Current application version**: 2.12.1 (Web UI 2.12.0)

- **[64-bit](https://web-builds.airdcpp.net/stable/airdcpp_2.12.1_webui-2.12.0_64-bit_portable.tar.gz)**
- **[32-bit](https://web-builds.airdcpp.net/stable/airdcpp_2.12.1_webui-2.12.0_32-bit_portable.tar.gz)**
- **[ARM](https://web-builds.airdcpp.net/stable/airdcpp_2.12.1_webui-2.12.0_armhf_portable.tar.gz)**
