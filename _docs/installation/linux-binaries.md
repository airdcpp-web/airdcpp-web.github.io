...
**Current application version**: 2.13.0 (Web UI 2.13.0)

- **[64-bit](https://web-builds.airdcpp.net/stable/airdcpp_2.13.0_webui-2.13.0_64-bit_portable.tar.gz)**
- **[32-bit](https://web-builds.airdcpp.net/stable/airdcpp_2.13.0_webui-2.13.0_32-bit_portable.tar.gz)**
- **[ARM](https://web-builds.airdcpp.net/stable/airdcpp_2.13.0_webui-2.13.0_armhf_portable.tar.gz)**
